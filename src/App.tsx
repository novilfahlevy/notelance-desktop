        ...
        <ul className="flex flex-col gap-y-2">
          <li
            className={`flex items-center ${isCategoriesPanelOpen ? 'justify-between' : 'justify-center'} rounded-lg cursor-pointer p-3
              hover:bg-accent-800/20 transition-all duration-150`}
          >
          ...
          >
            <div className="flex items-center gap-x-3">
              ...
              {isCategoriesPanelOpen && <p className="text-base">Kerja</p>}
            </div>
            {isCategoriesPanelOpen && <span className="text-accent-300 text-sm">12</span>}
          </li>
        </ul>

        {/* Add Category Button */}
        {isCategoriesPanelOpen && (
          <button className="flex items-center justify-center gap-x-2 mt-auto py-2 px-3 rounded-md border border-border-default hover:border-accent-500 hover:text-accent-500 transition-all">
